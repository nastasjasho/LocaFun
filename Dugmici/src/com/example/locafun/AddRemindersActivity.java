	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		button.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				Reminder reminder = new Reminder(taskText.getText().toString(),
						detailsText.getText().toString());
				DataStorage.get(AddRemindersActivity.this).saveReminder(
						reminder);
				Toast.makeText(AddRemindersActivity.this, reminder.toString(),
